...
@section('content')
    <div class="content-wrapper">
        ...
        <body>
            <div class="header">
                <h3>StokMate - Laporan Barang Keluar</h3>
            ...
            <!-- Konten lainnya -->
                                        ...
                                        `);
                                        printWindow.document.write(
                                            '<table><thead><tr><th>No</th><th>ID Transaksi</th><th>Tanggal</th><th>Barang</th><th>Jumlah Keluar</th><th>Satuan</th></tr></thead><tbody>'
                                        );
                                        data.forEach(function(item, index) {
                                            printWindow.document.write(`
                                                <tr>
